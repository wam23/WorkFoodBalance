...
var AbstractLevelScene = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  function AbstractLevelScene(levelname) {
    var _this;
    ...
    _this.collectedSausages = 0;
    _this.collectedBeers = 0;
  ...
  _createClass(AbstractLevelScene, [{
    ...
    value: function create() {
      ...
      this.collectedBeersScoreText = this.add.text(16, 16, 'Beers: 0', {
        fontSize: '32px',
        fill: '#000'
      });
      this.collectedSausagesScoreText = this.add.text(16, 48, 'Sausages: 0', {
        fontSize: '32px',
        fill: '#000'
      });
    ...
    value: function afterCreate() {
      ...
      this.physics.add.collider(this.sausages, this.platforms); //this.physics.add.collider(this.bombs, this.platforms);
      //  Checks to see if the player overlaps with any of the stars, if he does call the collectStar function

      this.physics.add.overlap(this.player, this.beers, this.collectBeer, null, this);
      this.physics.add.overlap(this.player, this.sausages, this.collectSausage, null, this); //this.physics.add.collider(this.player, this.bombs, this.hitBomb, null, this);
    }
  }, {
    key: "update",
    value: function update() {
    ...
    key: "collectBeer",
    value: function collectBeer(player, beer) {
    ...
    key: "collectSausage",
    value: function collectSausage(player, sausage) {
...
var Level1Scene = /*#__PURE__*/function (_AbstractLevelScene) {
  ...
  function Level1Scene() {
    ...
    return _super.call(this, _CST.CST.SCENES.LEVEL1);
  }
  ...
  _createClass(Level1Scene, [{
    ...
    key: "create",
    value: function create() {
      _get(_getPrototypeOf(Level1Scene.prototype), "create", this).call(this); // this.platforms.create(600, 520, 'platform');
    ...
    key: "update",
    value: function update() {
      _get(_getPrototypeOf(Level1Scene.prototype), "update", this).call(this);
    }
  }]);
...
var roundHalf = function roundHalf(num) {
...
var DPR = window.devicePixelRatio * graphicsSettings.best;
var _window$screen = window.screen,
    width = _window$screen.width,
    height = _window$screen.height; // Set width and height.

var WIDTH = Math.round(Math.max(width, height) * DPR);
var HEIGHT = Math.round(Math.min(width, height) * DPR);
var assetsDPR = roundHalf(Math.min(Math.max(HEIGHT / 360, 1), 4));
exports.assetsDPR = assetsDPR;
console.log('DPR = ', DPR);
...
},{"./scenes/LoadScene.js":"src/scenes/LoadScene.js","./scenes/MenuScene.js":"src/scenes/MenuScene.js","./scenes/Level1Scene.js":"src/scenes/Level1Scene.js"}],"../../Users/Mobi/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../Users/Mobi/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","src/main.js"], null)
