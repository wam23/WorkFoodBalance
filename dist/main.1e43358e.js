...
exports.LEADER_BOARD_URL = exports.CST = void 0;
var CST = {
  SCENES: {
    BOOT: "BOOT",
    LOAD: "LOAD",
...
var MenuScene = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  _createClass(MenuScene, [{
    ...
    value: function updateSoundButtonState() {
...
var ScoreScreen = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  _createClass(ScoreScreen, [{
    ...
    value: function getHighScore() {
      var url = _CST.LEADER_BOARD_URL + 'get_high_score';
      var request = new XMLHttpRequest();
...
var AbstractLevelScene = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  function AbstractLevelScene(levelname, nextlevel, nextlevelNumber, bgimage, maxTime) {
    var _this;
    ...
    _this.timer = null;
    _this.timeElapsed = 0;
    _this.timeLeft = _this.maxTime;
    _this.timeLeftText = _this.maxTime.toString();
    return _this;
  }
    ...
    value: function update() {
      ...
      if (this.scene.key == _CST.CST.SCENES.LEVEL1) {
        if (!this.drehkreuzSoundPlayed && this.player.body.position.x > 8300) {
          ...
          this.sound.get('background').volume = 0;
          this.drehkreuzSound.on('complete', this.restoreBackgroundSoundLevel, {
            sound: this.sound
          });
...
var Level1Scene = /*#__PURE__*/function (_AbstractLevelScene) {
  ...
  function Level1Scene() {
    ...
    return _super.call(this, _CST.CST.SCENES.LEVEL1, _CST.CST.SCENES.LEVEL2, 2, 'sky_level1', 150);
  }
...
var Level2Scene = /*#__PURE__*/function (_AbstractLevelScene) {
  ...
  function Level2Scene() {
    ...
    return _super.call(this, _CST.CST.SCENES.LEVEL2, _CST.CST.SCENES.LEVEL3, 3, 'sky_level2', 150);
  }
...
var Level3Scene = /*#__PURE__*/function (_AbstractLevelScene) {
  ...
  function Level3Scene() {
    ...
    return _super.call(this, _CST.CST.SCENES.LEVEL3, _CST.CST.SCENES.MENU, 0, 'sky_level3', 100);
  }
